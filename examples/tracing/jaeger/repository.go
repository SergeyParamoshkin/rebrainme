...
func (r *Repository) InitSchema(ctx context.Context) error {
	span, ctx := opentracing.StartSpanFromContextWithTracer(ctx, r.tracer, "Repository.InitSchema")
	defer span.Finish()
...
func (r *Repository) GetUser(ctx context.Context, id uuid.UUID) (*User, error) {
	span, ctx := opentracing.StartSpanFromContextWithTracer(ctx, r.tracer, "Repository.GetUser")
	defer span.Finish()
...
func (r *Repository) GetUsers(ctx context.Context) ([]User, error) {
	span, ctx := opentracing.StartSpanFromContextWithTracer(ctx, r.tracer, "Repository.GetUsers")
	defer span.Finish()
...
func (r *Repository) GetUserArticles(ctx context.Context, userID uuid.UUID) ([]Article, error) {
	span, ctx := opentracing.StartSpanFromContextWithTracer(ctx, r.tracer, "Repository.GetUserArticles")
	defer span.Finish()
